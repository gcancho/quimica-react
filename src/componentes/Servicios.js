    ...
    return ( 
        <article className="servicios">
            <div className="servicios__wrap wrap">
                <ServiciosCard icono={faTruck} titulo="Envío gratis" descripcion="Por compras mayores a S/100"/>
                ...
                <ServiciosCard icono={faWallet} titulo="Pago seguro" descripcion="Comprar aquí es 100% seguro"/>
            </div>
        </article>
     );
}
